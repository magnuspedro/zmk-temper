...
Dropped from Corne: `CAPS`, `LS(6)`, `LS(\`)`, `'` (SQT), `\``.
**SQT (`'`)** is the only commonly-used loss — relocate if needed.
...
│ STU │  ▽  │  ▽  │  ▽  │GAME │   │  ▽  │  ▽  │  ▽  │  ▽  │  ▽  │
├─────┼─────┼─────┼─────┼─────┤   ├─────┼─────┼─────┼─────┼─────┤
│ BT0 │ BT1 │ BT2 │ BT3 │ BT4 │   │MS←  │MS↓  │MS↑  │MS→  │  ▽  │
├─────┼─────┼─────┼─────┼─────┤   ├─────┼─────┼─────┼─────┼─────┤
│  ▽  │  ▽  │  ▽  │  ▽  │  ▽  │   │  ▽  │  ▽  │  ▽  │  ▽  │  ▽  │
╰─────┴─────┼─────┼─────┼─────┤   ├─────┼─────┼─────┼─────┴─────╯
            │  ▽  │  ▽  │  ▽  │   │ MB2 │ MB1 │ MB3 │
...
`STU` = `&studio_unlock`. `GAME` = `&to 7`. Dropped from Corne: `&bt BT_CLR`
(left col 0 row 1).
...
`NWP`/`PWP` = next/prev workspace macros. `cNWP`/`cPWP` = shift+move-with-window
variants.
